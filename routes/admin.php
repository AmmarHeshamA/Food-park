...
Route::group(["prefix" => "admin", "as" => "admin."], function () {
    ...
    Route::put('profile', [ProfileController::class, 'updateProfile'])
        ->name('profile.update'); // admin.profile.update

    Route::put('profile/password', [ProfileController::class, 'updatePasswordProfile'])
        ->name('profile.password.update'); // admin.profile.password.update

    // Slider Routes
    Route::resource('slider', SliderController::class)->except('show');

    // Why Choose Us
    Route::put('why-choose-title-update', [WhyChooseController::class, 'updateTitle'])->name('why-choose-title.update');
    Route::resource('why-choose-us', WhyChooseController::class)->except('show');
    ...
    Route::resource('product-option', ProductOptionController::class)->only(['store', 'destroy']);
