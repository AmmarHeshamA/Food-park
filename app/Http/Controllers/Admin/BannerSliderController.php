...
class BannerSliderController extends Controller
{
    ...
    {
        $imagePath = $this->uploadImage($request, 'image' , '/uploads/ad');
        ...
        return to_route('admin.banner-slider.index')->with('status', 'success');
    }
    ...
    {
        $imagePath = $this->uploadImage($request, 'image', '/uploads/ad' ,$request->old_image);
